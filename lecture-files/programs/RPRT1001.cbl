      ...
      *                                                                 00030099
       ...
       FILE-CONTROL.                                                    00060075
           ...
           SELECT BRANCHFL ASSIGN TO BRANCHFL.                          00092199
      *                                                                 00093099
      ...
      *                                                                 00152899
       FD  BRANCHFL.                                                    00152999
       01 BRNCH-AREA        PIC X(132).                                 00153099
      *                                                                 00153199
       WORKING-STORAGE SECTION.                                         00153299
      *                                                                 00153399
       01  SWITCHES.                                                    00153499
           05  CUSTMAST-EOF-SWITCH     PIC X    VALUE "N".              00153599
      *                                                                 00153699
       01  PRINT-FIELDS.                                                00153799
           05  PAGE-COUNT      PIC S9(3)   VALUE ZERO.                  00153899
           05  LINES-ON-PAGE   PIC S9(3)   VALUE +55.                   00154099
           05  LINE-COUNT      PIC S9(3)   VALUE +02.                   00155099
           05  SPACE-CONTROL   PIC S9      VALUE ZERO.                  00156099
      *                                                                 00157099
       01  TOTAL-FIELDS.                                                00158099
           05  GRAND-TOTAL1-THIS-YTD   PIC S9(7)V99   VALUE ZERO.       00159099
           05  GRAND-TOTAL1-LAST-YTD   PIC S9(7)V99   VALUE ZERO.       00160099
           05  GRAND-TOTAL2-THIS-YTD   PIC S9(7)V99   VALUE ZERO.       00161099
           05  GRAND-TOTAL2-LAST-YTD   PIC S9(7)V99   VALUE ZERO.       00162099
      *                                                                 00170099
      ...
      *                                                                 00390099
       01  HEADING-LINE-2.                                              00400099
           ...
           05  FILLER          PIC X(10)   VALUE "RPT1001".             00460099
      ...
      *                                                                 00700099
       01  GRAND-TOTAL-LINE1.                                           00710099
           05  FILLER              PIC X(27)    VALUE SPACE.            00720099
           05  GTL-SALES-THIS-YTD1  PIC Z,ZZZ,ZZ9.99-.                  00730099
           05  FILLER              PIC X(1)     VALUE SPACE.            00740099
           05  GTL-SALES-LAST-YTD1  PIC Z,ZZZ,ZZ9.99-.                  00750099
       01  GRAND-TOTAL-LINE2.                                           00751099
           05  FILLER              PIC X(27)    VALUE SPACE.            00752099
           05  GTL-SALES-THIS-YTD2  PIC Z,ZZZ,ZZ9.99-.                  00753099
           05  FILLER              PIC X(1)     VALUE SPACE.            00754099
           05  GTL-SALES-LAST-YTD2  PIC Z,ZZZ,ZZ9.99-.                  00755099
      ...
      *                                                                 01120099
           ...
           MOVE CUSTOMER-LINE TO BRNCH-AREA.                            01190199
           IF CM-SALES-THIS-YTD > CM-SALES-LAST-YTD                     01191099
              ADD CM-SALES-THIS-YTD TO GRAND-TOTAL1-THIS-YTD            01191199
              ADD CM-SALES-LAST-YTD TO GRAND-TOTAL1-LAST-YTD            01191299
              WRITE PRINT-AREA                                          01192099
           ELSE                                                         01193099
              ADD CM-SALES-THIS-YTD TO GRAND-TOTAL2-THIS-YTD            01193199
              ADD CM-SALES-LAST-YTD TO GRAND-TOTAL2-LAST-YTD            01193299
              WRITE BRNCH-AREA                                          01193399
           END-IF.                                                      01194099
           ADD 1 TO LINE-COUNT.                                         01210099
           MOVE 1 TO SPACE-CONTROL.                                     01240099
      *                                                                 01250099
      ...
      *                                                                 01270099
           ...
           WRITE PRINT-AREA.                                            01300199
           MOVE HEADING-LINE-1 TO BRNCH-AREA.                           01301099
           WRITE BRNCH-AREA.                                            01311099
           MOVE HEADING-LINE-2 TO PRINT-AREA.                           01320099
           WRITE PRINT-AREA.                                            01320199
           MOVE HEADING-LINE-2 TO BRNCH-AREA.                           01321099
           WRITE BRNCH-AREA.                                            01331099
           MOVE HEADING-LINE-3 TO PRINT-AREA.                           01340099
           WRITE PRINT-AREA.                                            01340199
           MOVE HEADING-LINE-3 TO BRNCH-AREA.                           01341099
           WRITE BRNCH-AREA.                                            01351099
           MOVE HEADING-LINE-4 TO PRINT-AREA.                           01360099
           WRITE PRINT-AREA.                                            01360199
           MOVE HEADING-LINE-4 TO BRNCH-AREA.                           01361099
           WRITE BRNCH-AREA.                                            01363099
      *                                                                 01370099
       300-PRINT-GRAND-TOTALS.                                          01380099
      *                                                                 01390099
           MOVE GRAND-TOTAL1-THIS-YTD TO GTL-SALES-THIS-YTD1.           01400099
           MOVE GRAND-TOTAL1-LAST-YTD TO GTL-SALES-LAST-YTD1.           01410099
           MOVE GRAND-TOTAL-LINE1    TO PRINT-AREA.                     01420099
           WRITE PRINT-AREA.                                            01420199
           MOVE GRAND-TOTAL2-THIS-YTD TO GTL-SALES-THIS-YTD2.           01420299
           MOVE GRAND-TOTAL2-LAST-YTD TO GTL-SALES-LAST-YTD2.           01420399
           MOVE GRAND-TOTAL-LINE2    TO BRNCH-AREA.                     01421099
           WRITE BRNCH-AREA.                                            01440099
