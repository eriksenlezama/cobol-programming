      ...
      *                                                                 00101099
       ...
       01  CUSTOMER-MASTER-RECORD.                                      00150799
           ...
           05  CM-PERCENT-OF-CH        PIC 9(2)V9(1).                   00151499
           05  FILLER                  PIC X(34).                       00151599
      *                                                                 00151699
      ...
      *                                                                 00153099
       01  CHANGE                      PIC 9(5)V9(2).                   00153199
      *                                                                 00153299
       01  SWITCHES.                                                    00153399
           05  CUSTMAST-EOF-SWITCH     PIC X    VALUE "N".              00153499
      *                                                                 00153599
       01  PRINT-FIELDS.                                                00153699
           05  PAGE-COUNT      PIC S9(3)   VALUE ZERO.                  00153799
      ...
      *                                                                 00480099
       01  HEADING-LINE-3.                                              00490099
           05  FILLER      PIC X(20)   VALUE "CUSTOMER            ".    00500099
           05  FILLER      PIC X(20)   VALUE "                  SA".    00510099
           05  FILLER      PIC X(20)   VALUE "LES         SALES   ".    00520099
           05  FILLER      PIC X(72)   VALUE SPACE.                     00530099
      *                                                                 00540099
       01  HEADING-LINE-4.                                              00550099
           05  FILLER      PIC X(20)   VALUE "BN SN NUM    CUSTOME".    00560099
           05  FILLER      PIC X(20)   VALUE "R NAME           THI".    00570099
           05  FILLER      PIC X(20)   VALUE "S YTD      LAST YTD ".    00580099
           05  FILLER      PIC X(20)   VALUE " % CHANGE           ".    00581099
           05  FILLER      PIC X(52)   VALUE SPACE.                     00590099
      *                                                                 00600099
       01  CUSTOMER-LINE.                                               00610099
           05  CL-CUSTOMER-BR-NUM  PIC 9(2).                            00620099
           05  FILLER              PIC X(1)     VALUE SPACE.            00630099
           05  CL-CUSTOMER-SAL-NUM PIC 9(2).                            00631099
           05  FILLER              PIC X(1)     VALUE SPACE.            00632099
           05  CL-CUSTOMER-NUMBER  PIC 9(5).                            00633099
           05  FILLER              PIC X(2)     VALUE SPACE.            00634099
           ...
           05  FILLER              PIC X(4)     VALUE SPACE.            00681099
           05  CL-PERCENT-OF-CH    PIC ZZ9.9-.                          00691099
           05  FILLER              PIC X(1)     VALUE "%".              00692099
           05  FILLER              PIC X(53)    VALUE SPACE.            00693099
      *                                                                 00700099
       01  GRAND-TOTAL-LINE.                                            00710099
           05  FILLER              PIC X(33)    VALUE SPACE.            00720099
      ...
      *                                                                 01120099
           ...
           MOVE CM-BRANCH-NUMBER    TO CL-CUSTOMER-BR-NUM.              01141099
           MOVE CM-SALESREP-NUMBER  TO CL-CUSTOMER-SAL-NUM.             01142099
           ...
           COMPUTE CHANGE = CM-SALES-THIS-YTD - CM-SALES-LAST-YTD.      01180199
           IF CM-SALES-LAST-YTD = ZERO                                  01180499
               MOVE 999.9 TO CL-PERCENT-OF-CH                           01180599
           ELSE                                                         01180699
               COMPUTE CL-PERCENT-OF-CH ROUNDED =                       01180799
                   CHANGE * 100 / CM-SALES-LAST-YTD                     01180899
                   ON SIZE ERROR                                        01180999
                       MOVE 999.9 TO CL-PERCENT-OF-CH.                  01181099
      *    SUBTRACT CM-SALES-LAST-YTD FROM CM-SALES-THIS-YTD            01181199
      *             GIVING CHANGE.                                      01181299
      *    IF CM-SALES-LAST-YTD = ZERO THEN                             01181399
      *      DIVIDE CHANGE BY 999.9 GIVING CM-PERCENT-OF-CH             01181499
      *    ELSE                                                         01181599
      *      DIVIDE CHANGE BY CM-SALES-LAST-YTD GIVING CM-PERCENT-OF-CH 01181699
      *    END-IF.                                                      01181799
      *    MULTIPLY CM-PERCENT-OF-CH BY 100 GIVING CM-PERCENT-OF-CH.    01181899
      *    MOVE CM-PERCENT-OF-CH    TO CL-PERCENT-OF-CH.                01182099
